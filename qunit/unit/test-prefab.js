...
(function () {
    ...
    test('instantiate prefab', function () {
        ...
        ok(Fire.hasMixin(newNode, TestScript), 'Should mixin script');
    ...
    asyncTest('revert prefab', function () {
        ...
        Fire.unMixin(testNode, TestScript);
        testChildN.scale = cc.Vec2.zero;
        Fire.mixin(testChildN, TestScript);
        ...
        Editor.PrefabUtils.revertPrefab(testWrapper, function () {
            ...
            strictEqual(Fire.hasMixin(testNode, TestScript), true, 'Restore removed mixin');
            ok(testNode.children[0].scale.equals(cc.v2(22, 11)), 'Revert child');
            strictEqual(Fire.hasMixin(testChildN, TestScript), false, 'Remove added mixin');
