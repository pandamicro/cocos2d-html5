...
//    strictEqual(node._prefab, null, "new object should not have prefab info");
//});
//
//(function () {
//
...
//
//    child.parent = node;
//    node.scale = cc.v2(123, 432);
//    child.scale = cc.v2(22, 11);
//    var ensureIdInitialized = node.uuid;
...
//        ok(newNode.scale.equals(cc.v2(123, 432)), 'Checking instance');
