...
var AssetLibrary = {
     ...
     * @param {_DeserializeInfo} options.deserializeInfo - specified a DeserializeInfo object if you want
     * @private
     */
    ...
    init: function (libraryPath, rawAssetsBase, rawAssets) {
        ...
        _libraryBase = cc.path.setEndWithSep(libraryPath, '/');
        cc.url._rawAssets = cc.path.setEndWithSep(rawAssetsBase || '', '/');
