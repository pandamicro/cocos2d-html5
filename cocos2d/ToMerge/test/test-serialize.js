...
describe('Serialize', function () {
    ...
    if (!spawnRunner(this, __filename, false, true, true)) {
        return;
    }
    ...
    describe('test inherited FireClass', function() {
        var MyAsset = Fire.extend('MyAsset', cc.Asset, function () {
            this.array = [1, '2', {a:3}, [4, [5]], true];
        });
        ...
        asset._objFlags |= cc.CCObject.Flags.Destroying;   // should not serialize
    ...
    describe('test FireClass', function () {
        ...
        Sprite.prop('size', new cc.Vec2(128, 128));
    ...
    describe('test CCObject reference', function () {
