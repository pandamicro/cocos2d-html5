...
describe( 'test Particle wrapper', function () {
    ...
    function setShareProperties () {
        ...
        wrapper.positionType = Runtime.ParticlePositionType.Free;
    }

    function setGravityModeProperties () {
        wrapper.emitterMode = Runtime.ParticleEmitMode.Gravity;
    ...
    function setRadiusProperties () {
        wrapper.emitterMode = Runtime.ParticleEmitMode.Radius;
